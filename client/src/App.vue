...
const API_URL = 'https://nginx-latest-1-mem4.onrender.com' // Your Render URL
...
async function copyToClipboard() {
  try {
    ...
    alert('Copied to clipboard!') // You can replace this with a nicer snackbar
  } catch (err) {
...
<style>
/* You can add global styles here, but Vuetify handles most of it! */
</style>
